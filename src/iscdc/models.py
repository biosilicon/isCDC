...
class Dataset(Base):
    ...
    organism: Mapped[str] = mapped_column(String(200), nullable=False, index=True)
    tissue: Mapped[str] = mapped_column(String(200), nullable=False, index=True)
...
class Modality(Base):
    ...
    technology: Mapped[str] = mapped_column(String(200), nullable=False, index=True)

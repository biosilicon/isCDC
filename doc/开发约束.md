...
Startup validates source binding, observation coverage/order, point files and QC counts.
A missing, stale or invalid domain sidecar must not disable valid cell-type visualization.
